...
# 2. Calcular el ESI interno, superficial y global de cada objeto 
#- para todos los planetas

peso = ['0.57', '1.07', '0.7', '5.58']  #definicion del values de peso

# Definicion de la funcion Planeta
# Planeta es una funcion que va a leer los datos asociados a cada uno de 
#los planetas
...
N_Planeta = [
]  # inicializar la lista que va a contener los nombre de los planetas
...
for i in range(
    ...
    ESI_int.append(
        float(Calculo_ESI_int)
    )  # addicionar los calculos de ESI_int de todos los planetas en la lista ESI_int
    ESI_sup.append(
        float(Calculo_ESI_sup)
    )  # addicionar los calculos de ESI_int de todos los planetas en la lista ESI_sup
    ESI_glb.append(
        float(Calculo_ESI_glb)
    )  # addicionar los calculos de ESI_int de todos los planetas en la lista ESI_glb

# Definicion de la funcion que va a determinar si cada objeto de la lista es similar a la Tierra (SI o NO)


def Teste(x, resultado='SI'):
    '''La funcion "Teste" va a verificar se el planeta x es similar a la Tierra (SI o NO). 
    ...
    Retorna
             retorna el resultado del teste de similitude.  Devuelve "SI" se ESI Global del planeta >= 0.8 y "NO" lo contrario
    '''
...
Resultado_Teste = [
]  # inicializar la lista que va a contener los resultados de lo teste/prueba de similitud
...
if not os.path.exists(
        path_carpeta
):  ## verificacion se la carpeta "TAREA1_2020" existe. Si no existe se va a crearla
...
#La informacion asociada a "YYMMDD" va a cambiar de acuerdo com la fecha de ejecucion del codigo
